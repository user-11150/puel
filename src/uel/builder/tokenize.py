    ...
    def make_tokens(self) -> list[UELToken]:
        ...
        while self.current_char is not None:
            ...
            if self.current_char == ' ' or self.current_char == '\n':
                ...
                self.advance()
                tokens.append(UELToken(TT_LPAR, '(', start_position, self.current_position))
            elif self.current_char == ')':
                self.advance()
                tokens.append(UELToken(TT_RPAR, ')', start_position, self.current_position))
            elif self.current_char == '+':
                self.advance()
                tokens.append(UELToken(TT_PLUS, '+', start_position, self.current_position))
            elif self.current_char == '-':
                self.advance()
                tokens.append(UELToken(TT_MINUS, '-', start_position, self.current_position))
            elif self.current_char == '*':
                self.advance()
                tokens.append(UELToken(TT_STAR, '*', start_position, self.current_position))
            elif self.current_char == '/':
                self.advance()
                tokens.append(UELToken(TT_SLASH, '/', start_position, self.current_position))
            elif self.current_char == '=':
                self.advance()
                tokens.append(UELToken(TT_EQEQUAL, '=', start_position, self.current_position))
            elif self.current_char == ';':
                self.advance()
                tokens.append(UELToken(TT_SEMI, ';', start_position, self.current_position))
                ...
                tokens.append(UELToken(token_type, identifier, start_position, self.current_position))
                self.advance()
                ...
                tokens.append(UELToken(TT_STRING, res, start_position, self.current_position))
                self.advance()
                ...
                while self.current_char in '0123456789.':
                    ...
                    self.advance()
                tokens.append(UELToken(TT_NUMBER, result, start_position, self.current_position))
            else:
