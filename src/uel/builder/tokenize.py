# -*- coding: utf-8 -*-
# Auto-generated by tools/generate/gen_tokenize.py from grammer/tokens, don't edit it
"""
UEL's tokenizer
"""
...
TT_ATTR = 'TT_ATTR'
TT_COMMA = 'TT_COMMA'
TT_KEYWORDS = ['import', 'function'];TT_KEYWORD = 'TT_KEYWORD';TT_EOF = 'TT_EOF'
class Token:
    TT_IDENTIFIER = 'TT_IDENTIFIER'
    TT_STRING = 'TT_STRING'
    TT_NUMBER = 'TT_NUMBER'
    ...
    def make_tokens(self) -> list[UELToken]:
        ...
        while self.current_char is not None:
            ...
            if self.current_char == " " or self.current_char == "\n":
                ...
                tokens.append(
                    UELToken(
                        TT_COMMA, ',', start_position, self.current_position
                    )
                )
